...
Версии
    ...
    1.1
        ...
        - В админку вынесен параметр "Автоматический логин" дает возможность формировать логин пользователя от
          имени социальной сети и его ид. в ней. По умолчанию логин вводит сам пользователь.
