...
$aConfig = array(
    ...
    // Экспресс-регистрация пользователя. В таком режиме работы после выбора социальной
    // сети если логин и email получен от провайдера, то регистрация происходит моментально
    // без страницы подтверждения. Если занят логин, то он будет запрошен у пользователя.
    // Тоже будет и с email. По умолчанию возможность отключена.
    'express' => FALSE,
